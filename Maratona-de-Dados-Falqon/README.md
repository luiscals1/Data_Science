...
### Este projeto foi desenvolvido durante a Maratona de Dados Falqon, foi efetuadas etapas de um projeto real de Data Science, usando dados de uma rede de lojas, executando um ETL (executando um ETL (Extract, Transform, Load), e dados do mercado de ações do Google para realização de predição dos valores dessas ações.
